...
<head>
    ...
    <!-- favicons -->
    <link rel="shortcut icon" href="{% static 'jazzmin/img/gear-solid.svg' %}" type="image/png">
        ...
        {% if jazzmin_settings.show_sidebar %}
            ...
            <aside class="main-sidebar elevation-4 {{ jazzmin_ui.sidebar_classes }}" id="jazzy-sidebar">
                <a href="{% url 'admin:index' %}" class="brand-link {{ jazzmin_ui.brand_classes }}" id="jazzy-logo">
                    <img src="http://internetpplus.com/wp-content/uploads/2020/03/Logo-iP-02.png" alt="" class="{{ jazzmin_settings.site_logo_classes }} brand-image elevation-3" style="opacity: .8">
